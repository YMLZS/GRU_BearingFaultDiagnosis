...
def train(model_save_path, train_result_path, val_result_path, hp_save_path, epochs=100):
    ...
    #加载数据
    train_path = r'F:\PyCharmWorkSpace\MultiFD\data\cu_data_noisy\-5db\train\train.csv'
    val_path = r'F:\PyCharmWorkSpace\MultiFD\data\cu_data_noisy\-5db\val\val.csv'
    ...
    #定义模型
    model = GRU(input_dim=input_dim, input_size=seq_len, hidden_size=hidden_size, hidden_num_layers=N)
